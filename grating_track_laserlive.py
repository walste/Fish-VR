...
if __name__ == "__main__":
    ...
    event = [p for p in dir(cv2) if 'EVENT' in p]
    try:
...
#---------------------------# Please correct this function (threading)... #------------------#
    ...
    if starting_mode == 1:
        ...
        save_thread = threading.Thread(target=save_frames, args=(save_queue,save_thread_stop_requested, movie_fname, roi, starting_mode, event))
        save_thread.start()
